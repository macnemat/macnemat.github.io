    ...
    <div className="Featured-Projects">
      <CardGroup>
        ...
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="../src/assets/HomeLogo_no_words.png" />
          <Card.Body>
        ...
        <a href="https://mkashew13.wixsite.com/project-mammoth">
        <Card style={{ width: '18rem' }}>
        ...
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="../src/assets/tahpinLogoSnip.jfif" />
          <Card.Body>
