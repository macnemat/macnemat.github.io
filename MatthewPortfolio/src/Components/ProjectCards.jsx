...
function ProjectCards() {
  ...
  const handleCloseTactics = () => setShowTactics(false);
  const handleShowTactics = () => setShowTactics(true);
  ...
  return (
    <div className="Featured-Projects">
          ...
          <Col>
            <Card onClick={handleShowMammoth} style={{ cursor: 'pointer', width: '18rem', height: '24rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Technical Lead on Hologram installation Project Mammoth
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col>
            <Card onClick={handleShowtahpin} style={{ cursor: 'pointer', width: '18rem', height: '24rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Designer and Programmer for mobile application Tahpin.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Modal.Body>
          <Container>
            ...
            <p className='Mod-Body-Text'>
              Project Mammoth is a hologram display focused on raising awareness of endangered species across the planet.
            ...
            <p className='Mod-Body-Text'>
              ...
              The entire setup was built using a Raspberry Pi as the central computing system that would be connected to both the TV and gesture interface.
            </p>
        ...
        <Modal.Body>
          <Container>
            ...
            <p className='Mod-Body-Text'>
              ...
              HOME was built using an Oculus Quest 2 headset and would have the user move through scripted set pieces to follow the through simulation.
            ...
            <p className='Mod-Body-Text'>
              ...
              Each of the rooms has a floor map in which the user can teleport around. For the Panic Room, I had to ensure we had a working interaction system that would allow the user to pick up the eggs for the section.
              The room has several stages that the player triggers upon reaching certain parts of the room. The different stages affect the voice lines that are played, the sound level, the light level, the position of the ceiling,
            ...
            <p className='Mod-Body-Text'>
              The Schizophrenia room is a more linear experience that presents a series of different events that may or may not be real. The experience involves multiple moving pieces such as, shadows moving across the walls, voices talking from different directions,
        ...
        <Modal.Body>
          <Container>
            ...
            <p className='Mod-Body-Text'>
              ...
              The game requires the user to be able to read and analyze the question well enough to determine if the falling answer is correct or not and be able to catch the right answer and dodge the wrong answers.
            </p>
      ...
      <Modal show={showTactics} onHide={handleCloseTactics} dialogClassName="modal-90w">
        <Modal.Body>
          <Container>
            <Row>
              <Col>
              ...
              <Col>
                <h1 className='Mod-Title-Text'>Turn-Based Tactics Demo</h1>
            ...
            <p className='Mod-Body-Text'>
              ...
              All units from one side may make an action on their turn, after which the opposing set of units can take their actions.
              ...
              I’ve created a working demo technical demo with the dream of being able to build the project further.
            </p>
            ...
            <p className='Mod-Body-Text'>
              Pathfinding is a crucial part of any turn-based strategy game in terms of not just the path a unit can walk on but the areas that are walkable themselves, along with the attackable areas.
              In order to get an accurate overlay of walkable cells the use of Dijkstra’s Algorithm was necessary and is the backbone of the grid system.
            </p>
            ...
            <p className='Mod-Body-Text'>
              Each unit has a list of stats, weapons, and spells. Stats affect different aspects of the combat, weapons are the method by which a unit may attack an enemy, armour can increase the
              defensive stats of a unit, and spells can be used to attack an enemy or heal/enhance an ally. The biggest challenge with units was having a unit be able to contain a list of stats
              and items without either being directly tied to the unit object itself. Godot’s Resources were a massive help as they are able to contain all the information regarding
            ...
            <p className='Mod-Body-Text'>
              To try to mimic large-scale engagements I created the battalion system. A battalion is made up of several individual units under one united battalion. The battalions have their own map to move on but once engaged
            ...
            <p className='Mod-Body-Text'>
              Developing this project has been a dream come true, looking back at when I first started this project I can't help but be proud of the work I've accomplished. Every challenge and obstacle
        ...
        <Modal.Footer>
          <Button onClick={handleCloseTactics} variant="secondary">
            Close
          </Button>
        </Modal.Footer>
      </Modal>
